...
export default function ARScreen() {
  ...
  const panResponder = PanResponder.create({
    ...
    onPanResponderGrant: () => { posRef.current = { ...pos }; },
    onPanResponderMove: (_, gs) => {
      setPos({ x: posRef.current.x + gs.dx, y: posRef.current.y + gs.dy });
    },
  });
  ...
  return (
    <View style={s.container}>
      ...
      {/* Vista capturada: cámara + overlay */}
      ...
      <View style={s.topBar} pointerEvents="box-none">
        ...
        <View style={s.topHint}>
          <Text style={s.hintText}>Arrastra el tatuaje para posicionarlo</Text>
        </View>
        <TouchableOpacity
          style={s.iconBtn}
...
const s = StyleSheet.create({
  ...
  tattooOverlay: { position: 'absolute', borderRadius: 8 },
  ...
  permissionBtn: {
    backgroundColor: '#C0392B', paddingHorizontal: 28, paddingVertical: 12, borderRadius: 10,
  },
